...
$gourmetGoldMousse = new CatFoodProduct('Gourmet Gold Mousse 24 x 85 g Alimento umido per gatti', '13,49', './Views/img/cans_24_1000x1000_4.jpg','Alimento umido per gatti Gourmet Gold Mousse, a base di tenerissime mousse di carne o di pesce, con componenti freschi di alta qualità.','Cat', 'Food');
$roccoClassic = new DogFoodProduct('Rocco Classic 6 x 400 g Alimento umido per cani', '8,99', './Views/img/rocc_classic_rindpur_400g_hs_01_8.jpg','Alimento umido Rocco Classic 6 x 400 g senza cereali per cani adulti, con un\'elevata percentuale di carne e interiora, componenti 100% freschi della migliore qualità.','Dog', 'Food');
